    ...
    <div className='card' style={{backgroundColor: '#ffffe0'}}>
        ...
        <nav class="pagination is-right" role="navigation" aria-label="pagination">
              <ul class="pagination-list">
                ...
                <li><a class="pagination-link" aria-label="Goto page 1"><NavLink to={"/partikelk3"} style={{color: 'black'}}>3</NavLink></a></li>
                <li><a class="pagination-link" aria-label="Goto page 1" style={{backgroundColor: '#8B4513'}}><NavLink to={"/partikelk4"} style={{color: 'white'}}>4</NavLink></a></li>
