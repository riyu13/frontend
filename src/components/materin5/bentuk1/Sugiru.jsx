        ...
        <div className='card-content'>
            <nav class="pagination is-right" role="navigation" aria-label="pagination">
              <ul class="pagination-list">
                <li><a class="pagination-link" aria-label="Goto page 1"><NavLink to={"/bentuk1"} style={{color: 'black'}}>1</NavLink></a></li>
                <li><a class="pagination-link" aria-label="Goto page 1"><NavLink to={"/tai"} style={{color: 'black'}}>2</NavLink></a></li>
                <li><a class="pagination-link" aria-label="Goto page 1" style={{backgroundColor: '#8B4513'}}><NavLink to={"/sugiru"} style={{color: 'white'}}>3</NavLink></a></li>
                <li><a class="pagination-link" aria-label="Goto page 1"><NavLink to={"/yasui"} style={{color: 'black'}}>4</NavLink></a></li>
              </ul>
            </nav>
